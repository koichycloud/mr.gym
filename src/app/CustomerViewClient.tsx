        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center animate-fade-in" style={{ backgroundColor: '#3f2009' }}>
                <div className="max-w-4xl w-full">
                    <h1 className="text-[5rem] font-black text-white mb-8 tracking-tighter uppercase drop-shadow-lg" style={{ WebkitTextStroke: '4px black', paintOrder: 'stroke fill' }}>
                        Mr. Gym
                    </h1>
                    <p className="text-4xl font-light" style={{ color: '#cc99ff', opacity: 0.7 }}>
